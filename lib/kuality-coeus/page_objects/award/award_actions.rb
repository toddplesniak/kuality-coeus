class AwardActions < KCAwards
  ...
  p_action(:child_of_target_award) { |award, b| b.award_div(award).select(name: /copyAwardPanelTargetAward/).set }
  ...
  p_action(:based_on_target_award) { |award, b| b.award_div(award).select(name: /newChildPanelTargetAward/).set }
