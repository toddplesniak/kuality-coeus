class SpecialReviewObject < DataFactory
  ...
  def initialize(browser, opts={})
    ...
    defaults = {
        ...
        type:            [ 'Human Subjects', 'Animal Usage', 'Recombinant DNA', 'Radioactive Isotopes',
                           'Biohazard Materials', 'International Programs', 'Intellectual Property/Tech Transfer',
                           'Foundation Relations', 'Other'

        ].sample,
        approval_status: '::random::',
        press: 'save'
        # 'Recombinant DNA','Biohazard Materials','International Programs','Space Change',
